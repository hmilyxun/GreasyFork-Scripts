        ...
        void (async function (getUpdateAddress) {
          ...
          function preInstall(url) {
            sleep(5e2)(url.replace(".meta.", ".user."))
              ...
              .catch(e => ERROR(`${e.name} in PreInstall:`, e.message));
          }
